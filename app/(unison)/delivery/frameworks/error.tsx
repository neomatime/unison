...
export default function FrameworksError({ reset }: { error: Error & { digest?: string }; reset: () => void }) {
  return (
    <section className="flex min-h-72 flex-col items-center justify-center rounded-xl border border-border bg-card px-6 text-center">
      ...
      <p className="mt-1 text-sm text-muted-foreground">The Frameworks data could not be retrieved. Try the request again.</p>
