...
import type { listDependencyFormOptions } from '@/features/delivery/queries/list-dependency-form-options'
...
export function ProjectDetailScreen({ project, items, labels, dependsOn, dependedOnBy, options }: { project: ProjectDetail; items: DeliveryItemNode[]; labels: { level1Label: string | null; level2Label: string | null }; dependsOn: DependencyRow[]; dependedOnBy: DependencyRow[]; options: Awaited<ReturnType<typeof listDependencyFormOptions>> }) {
