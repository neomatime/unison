...
export function ProjectDetailScreen({ project, items, labels, dependsOn, dependedOnBy }: { project: ProjectDetail; items: DeliveryItemNode[]; labels: { level1Label: string | null; level2Label: string | null }; dependsOn: DependencyRow[]; dependedOnBy: DependencyRow[] }) {
